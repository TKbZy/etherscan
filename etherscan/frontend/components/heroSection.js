...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const y = document.querySelector('.Home_adSection__zTgQE')
                  ...
                  {transactionsResult.map((txn) => {
                    return (
                      ...
                      >
                        ...
                        <td className={styles.tdBlock}>
                          <CopyToClipboard text={txn.transactionHash} className={styles.blueText} title=""></CopyToClipboard>
                          <section>
                        ...
                        <td className={styles.tdFromTo}>
                          <section>
                            From{" "} 
                            <CopyToClipboard text={txn.fromAddress} className={styles.blueText} title=""></CopyToClipboard>
                          </section>
                          <section>
                            To{" "}  
                            <CopyToClipboard text={txn.toAddress} className={styles.blueText} title=""></CopyToClipboard>
                            <span className={styles.blueText}>
